        ...
        <button class="rules-btn" (click)="openRules()" aria-label="How to play">
          ...
          >
            ...
            <path
              opacity="0.5"
              fill="currentColor"
              d="M6.62,79.25l0.35-61.69H0v78.5c9.57-2.47,19.17-4.04,28.85-4.11
        ...
        <div class="exit-confirm-overlay">
          <div class="exit-confirm-dialog">
            ...
            <div class="exit-confirm-buttons">
              <button class="exit-confirm-yes" (click)="confirmExit()">
                {{ 'rowClosure.yes' | translate }}
              </button>
              <button class="exit-confirm-no" (click)="showExitConfirm.set(false)">
                {{ 'rowClosure.no' | translate }}
              </button>
            </div>
          </div>
        </div>
