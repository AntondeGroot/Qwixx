...
@Component({
          ...
          <div class="longo-rows">
            ...
            <div class="lock-zone longo-zone">
              ...
              <div class="longo-cell yellow" [class.cell-crossed]="yCell16()">
                <span class="cell-num">16</span>
                @if (yCell16()) {
                  <span class="anim-cross dark">✕</span>
                }
              </div>
  ...
  styles: [
    `
      ...
      :host ::ng-deep p strong {
        font-weight: 700;
      }
      :host ::ng-deep p em {
        font-style: italic;
      }
      :host ::ng-deep .tip strong {
        font-weight: 700;
      }
      :host ::ng-deep .tip em {
        font-style: italic;
      ...
      @keyframes pulse-glow-demo {
        0%,
        100% {
          box-shadow: 0 0 0 3px var(--glow-full);
        }
        50% {
          box-shadow:
            0 0 0 6px var(--glow-dim),
            0 0 18px 2px var(--glow-mid);
        }
      }
