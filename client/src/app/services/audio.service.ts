...
export class AudioService {
  ...
  static readonly UNDO_CROSS =
    'zapsplat_office_stationery_eraser_rubber_rubbing_out_pencil_on_paper_003_96019.mp3';
  static readonly PUNISHMENT =
    'zapsplat_foley_hand_on_carpet_several_fast_rubs_as_if_cleaning_004_67519.mp3';
